...
export const plans = [
  {
    ...
    features: [
      ...
      { title: "내 경험 기반 맞춤 스크립트", details: ["체험판 + 후기 제출 시 크레딧 지급", "1회 생성 = 7가지 학습콘텐츠", "핵심표현 · 만능패턴 · 연결어 하이라이팅"], enabled: true },
      { title: "내 스크립트로 원어민 발음 체화", details: ["내 스크립트가 원어민 음성으로 변환", "듣기 → 따라읽기 → 혼자말하기 → 실전 녹음", "쉐도잉 훈련 무제한"], enabled: true },
      { title: "기출 기반 실전 모의고사", details: ["모의고사 체험판", "기출 질문에서 실전과 동일하게 출제"], enabled: true },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "내 경험 기반 맞춤 스크립트", details: ["스크립트 패키지 생성 15회", "1회 생성 = 7가지 학습콘텐츠", "핵심표현 · 만능패턴 · 연결어 하이라이팅"], enabled: true },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "문항별 개별 평가 + 종합 리포트", details: ["10가지 유형별 맞춤 체크리스트", "과제충족 진단 + 최우선 처방 + 교정문", "영역별 실력 분석 + 성장 리포트"], enabled: true },
      { title: "약점 자동 처방 튜터링", details: ["튜터링 3회 포함", "모의고사 결과 기반 약점 진단 + 맞춤 처방", "병목별 3단계 드릴 + 미니 재평가"], enabled: true },
    ],
    cta: "구매하기",
    ctaLink: "/store",
